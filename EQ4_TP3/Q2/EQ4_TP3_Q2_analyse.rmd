...
Ici le code a été fait et le fichier créer. À noter que huge5 faisait planter mon système pour l'algorithme LPSOLVE... Donc, je l'ai retiré pour cet algorithme.
...
experiment <- function(matrix_, instance_,  nb_runs_){
  ...
  for (algo in algo_list){
    for (curr_run in 1:nb_runs) {
      ...
      experiments.table$instance[current_experiment] <- instance_
  ...
  if(file.exists(experiments_rds_filename)) {
    ...
    print("Le fichier experiment.rds avait été déjà créé!")
  } else{
      print("Le fichier experiment.rds n'existe pas. Génération du fichier experiment.rds! ")
      ...
      print("Le fichier experiment.rds vient d'être créé")
